...
## 当前未完成计划
- 修订 `消化系统/PBL作业/Case3-第一幕/Case3-第一幕.md` 的问题1、问题2表述，使其在保留当前主线和篇幅控制的前提下，补上老师/审稿视角下更稳的临床接口句与风险边界。
  - 先把当前 `Case3-第一幕.md` 作为基线版本入库，确保后续“小改版”有清晰对照。
  - 依据用户给出的修订意见与最新指南线索，重点补入“首次静脉曲张出血提示失代偿”“风险量化仍需结合红色征/Child-Pugh 等信息”“GBS 不能单独替代静脉曲张出血风险判断”“大量呕血需警惕误吸和气道风险”等小补丁。
  - 保持问题边界：问题1继续聚焦病史到病因链，问题2继续聚焦症状到初步诊断和危重判断，不提前吃掉问题5、6、8、9、10 的内容。
  - 完成后做 Markdown 结构与关键表述检查，确认没有引入新的 AI 草稿口吻、编号混乱或引用失配，再更新 `PROGRESS.md` 并提交。
