...
## 当前未完成计划
- Case2 思维导图按老师课堂总结正式化修订：
  1. 删除“整幕归纳版”“放大主线”“归纳总结，不按幕次硬拆”等明显像制作说明的括号标题，改成可直接提交的正式标题。
  2. 中心词从“急性前壁 STEMI”调整为“急性心肌梗死”，前壁 STEMI 和 LAD 责任血管作为本病例具体诊断证据放入诊断分支，避免主题过窄。
  3. 一级主题按老师要求保持并列：病因与危险因素、发病机制、诊断、鉴别诊断、治疗与管理、预后与并发症；PCI 归入治疗，不单独作为一级主题。
  4. 节点尽量改成短词或短句，保留病例证据颜色标注，体现“总的疾病知识 + 本病例具体情况”的关系。
  5. 修订后做关键词残留、一级标题、HTTP 页面返回和正式交付语气检查，再同步 `PROGRESS.md` 并提交。
