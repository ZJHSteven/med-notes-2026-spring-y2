...
## 当前未完成计划
- `循环系统/Notes` 教学大纲层级标签与覆盖核对
  1. 从 `C:/Users/ZJHSteven/Downloads/循环学习通/01-教学大纲与课程指南/教学大纲-循环系统-2023修订.pdf` 抽取理论课各章的“掌握 / 熟悉 / 了解”要求，并按 `1-16` 号课堂笔记建立章节映射。
  2. 仅对 `循环系统/Notes/1-开课介绍.md` 到 `循环系统/Notes/16-研究进展.md` 做微调，在老师实际讲到的对应内容附近补充 `【教学大纲标签】` 标记；`17-复习串讲.md` 和 PBL 笔记不纳入本轮正文改动。
  3. 生成一份覆盖核对清单，逐章确认“掌握 / 熟悉 / 了解”要求是否在课堂笔记中出现；对仅框架性提及或未见明显对应的点单独列出，方便后续补记。
  4. 完成静态核对：检查 16 份笔记都已加入层级标签、标签措辞与大纲一致、覆盖清单中的文件链接可直接回看。
