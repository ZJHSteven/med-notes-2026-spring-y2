...
- 循环系统 Case2 第一幕问题2两页PPT：
  - 目标：围绕“刘阿姨既往高血压、糖尿病及外卖/奶茶等生活方式如何增加急性心肌梗死风险”制作不超过两页、少文字多图示、适合 5-10 分钟讲解的 PPT。
  - 交付：生成可编辑 `.pptx`，题号暂不写死；页脚保留关键文献引用；封面/页眉保留姓名、班级、学号。
  - 资料：先复用 `循环系统/PBL作业/Case2-第一幕/Case2-第一幕.md` 中的问题2病例材料，再联网核对高血压、糖尿病、饮食和急性心梗机制的权威文献。
